...
$this->breadcrumbs=array(
    Language::t(Yii::app()->language,'Backend.Common.Menu','Translate'),
);
?>

<h1><?php echo Language::t(Yii::app()->language,'Backend.Common.Menu','Translate')?></h1>
    ...
    <div class="row">
        ...
        echo CHtml::activeDropDownList(
        		...
        		array(
					...
					'ajax' => array(
						'type'=>'POST', 
						'url'=>CController::createUrl('Language/changeList',array('action'=>'update')), 
