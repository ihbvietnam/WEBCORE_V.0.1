...
{	
	...
	public function codeUrl($type,$value=array()){
		switch ($type) {
			case 'controller': 
					return array('home'=>'Trang chủ','config'=>'Hệ thống','language'=>'Ngôn ngữ','setting'=>'Cấu hình','news'=>'Tin tức','product'=>'Sản phẩm','order'=>'Đơn hàng','user'=>'Người dùng','qa'=>'Hỏi đáp','galleryVideo'=>'Video','banner'=>'Banner','contact'=>'Liên hệ');				
				break;
			case 'action':
